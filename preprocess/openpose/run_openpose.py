...
class OpenPose:
    ...
    def __call__(self, input_image, resolution=384):
        ...
        # Image preprocessing steps remain outside the AMP context
        ...
        with torch.no_grad():
            # Start AMP autocast context only for PyTorch operations
...
if __name__ == '__main__':
    # Initialize the OpenPose model with the desired GPU ID, e.g., 0
